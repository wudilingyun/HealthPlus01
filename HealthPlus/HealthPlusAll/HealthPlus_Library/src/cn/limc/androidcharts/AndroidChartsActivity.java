...
public class AndroidChartsActivity extends Activity {
    ...
    private void initMAChart() {
        ...
        testLine.setTitle("MA5");
        testLine.setLineColor(Color.WHITE);
        testLine.setLineData(inittest());
        lines.add(testLine);
...
//        lines.add(MA25);
        ...
        machart.setMaxValue(250);
        machart.setMinValue(210);
    ...
    private List<Float> inittest() {
        List<Float> list = new ArrayList<Float>();
        for (int i = 10; i < 50; i++) {
            list.add((200F + Float.valueOf(i)));
        }
        return list;
    }
